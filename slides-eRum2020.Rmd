...
### Predicting complex diseases from genetics with a penalized logistic regression
...
### Predicting height from genetics with a penalized linear regression
...
.footnote[Slides created via the `r icon::fa_r_project()` package [**xaringan**](https://github.com/yihui/xaringan).]
