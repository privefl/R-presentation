...
## How do I choose the size of ggplot?
...
- Then, I use the dimensions that are displayed at the top in `ggsave()` with `scale = 1/75`, e.g. `ggsave("myggplot.png", scale = 1/75, width = 888, height = 725)`
