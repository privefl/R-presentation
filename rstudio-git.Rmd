...
<li>Many other miscellaneous enhancements and bug fixes.</li>
</ul>
...
background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHH9QYVUjA3IV0ptLQRXVAUBGBH-qXD7pG7wnj_34mwkTKS4NH0w)
...
### Because Master Yoda says so

```{r, out.width="55%"}
knitr::include_graphics("https://memegenerator.net/img/instances/28137756.jpg")
```
...
### Next session: Best coding practices

On February 08, 2018 by A. Arnaud & J. Arbel
...
### Next session: Make your personal webpage with R

On June 14, 2018 by F. Privé & M. Richard

Use R Markdown & GitHub to make websites, presentations & reports easily available online.
...
```{r, out.width="100%"}
knitr::include_graphics("https://memegenerator.net/img/instances/79811268.jpg")
```
...
## [Video](https://www.youtube.com/watch?v=YxZ8J2rqhEM)

## [Blog post](http://www.datasurg.net/2015/07/13/rstudio-and-github/)
